...
image_paths = list(paths.list_images('/home/johnorourke/Downloads/input/natural_images'))
...
# save as csv file
data.to_csv('/home/johnorourke/Downloads/input/data.csv', index=False)
# pickle the label binarizer
joblib.dump(lb, '/home/johnorourke/Downloads/output/lb.pkl')
...
df = pd.read_csv('/home/johnorourke/Downloads/input/data.csv')
...
lb = joblib.load('/home/johnorourke/Downloads/output/lb.pkl')
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('/home/johnorourke/Downloads/output/accuracy.png')
plt.show()
# loss plots
plt.figure(figsize=(10, 7))
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('/home/johnorourke/Downloads/output/loss.png')
plt.show()